                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                top: 15.h, right: 25.w, left: 25.w),
                            child: AdventureFormField(
                                onTap: () => _selectCertificationDate(context),
                                readOnly: true,
                                isRequired: true,
                                validator: (value) {
                                  return certificationDateController
                                          .text.isNotEmpty
                                      ? null
                                    ...
                                    onPressed:
                                      ...
                                      if (_formKey.currentState!.validate()) {
                                        DivingInsuranceModel divingData =
                                          ...
                                          nitrox_agency: nitroxAgencyController
                                              .text
                                              .trim(),
                                          nitrox_date: nitroxDate,
                                          nitrox_number: nitroxNumberController
                                              .text
                                              .trim(),
                                        );

                                        if (selectedDiveEquipment!.id == 0) {
                                          divingData.equipment_insurance = true;
