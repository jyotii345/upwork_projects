...
class _EmergencyContactState extends State<EmergencyContact> {
  ...
  void initState() {
    ...
    emergencyContactDetails(contactId: basicInfoModel.contactID!);
    getMasterData();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: AbsorbPointer(
          absorbing:
              form_status.emcontact == "1" || form_status.emcontact == "2"
                  ? true
                  : false,
          child: Container(
            child: Padding(
                          ...
                          child: AggressorButton(
                            onPressed: () async {
                              EmergencyContactModel saveData =
                                ...
                                emergency2_last:
                                    secondaryLastNameController.text,
                                emergency2_ph_home:
                                    secondaryHomePhoneController.text,
                                emergency2_ph_mobile:
                                    secondaryMobilePhoneController.text,
                                emergency2_ph_work:
                                    secondaryWorkPhoneController.text,
                                ...
                                emergency_countryID: primarySelectedCountry!.id,
                                ...
                                emergency_ph_mobile:
                                    primaryMobilePhoneController.text,
                                emergency_ph_work:
