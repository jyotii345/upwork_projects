                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Checkbox(
                                value:
                                    rentalsModel[1].subCategories![0].isChecked,
                                onChanged: (value) {
                                  setState(() {
                                    rentalsModel[1]
                                        .subCategories![0]
                              ...
                              Checkbox(
                                value:
                                    rentalsModel[1].subCategories![1].isChecked,
                                onChanged: (value) {
                                  setState(() {
                                    rentalsModel[1].subCategories![1].isChecked;
                                  });
                              ...
                              // Checkbox(
                              //   value:
                              //       rentalsModel[1].subCategories![2].isChecked,
                              //   onChanged: (value) {
                              //     setState(() {
                              //       rentalsModel[1].subCategories![2].isChecked;
                              //     });
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Checkbox(
                                value:
                                    rentalsModel[1].subCategories![3].isChecked,
                                onChanged: (value) {
                                  setState(() {
                                    rentalsModel[1].subCategories![3].isChecked;
                                  });
                              ...
                              Checkbox(
                                value:
                                    rentalsModel[1].subCategories![4].isChecked,
                                onChanged: (value) {
                                  setState(() {
                                    rentalsModel[1].subCategories![4].isChecked;
                                  });
