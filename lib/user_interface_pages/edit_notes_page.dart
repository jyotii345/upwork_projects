...
class EditNotes extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new EditNotesState();
}

class EditNotesState extends State<EditNotes> with AutomaticKeepAliveClientMixin {
  /*
  instance vars
   */
                  ...
                  setState(() {
                    ...
                    departureDate = DateTime.parse(newValue.charter.startDate)
                        ...
                        DateTime.parse(newValue.charter.startDate)
                            .year
                            .toString();
                    returnDate = DateTime.parse(newValue.charter.startDate)
                            .add(Duration(
                                days: int.parse(newValue.charter.nights)))
                            .month
                            .toString() +
                        "/" +
                        DateTime.parse(newValue.charter.startDate)
